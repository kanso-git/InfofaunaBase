            ...
            <div className={loginCss.Limiter}>
                <div className={loginCss.ContainerLogin100}>
                    <div className={loginCss.WrapLogin100}>
                        ...
                        {this.props.auth.error !== null ? <div className={loginCss.ErrorLogin}>Nom d'utilisateur ou mot de passe invalide</div> : null }
                        <Form>
...
export default connect(mapStateToProps, {...authActions})(withStyles(styles)(LoginForm))
