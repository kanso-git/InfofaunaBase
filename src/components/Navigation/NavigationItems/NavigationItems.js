        ...
        return (
            <ul className={navigationItemsCss.NavigationItems}>
                ...
                <div>
                    ...
                    >
                        <AccountCircle/> <span className={navigationItemsCss.User} >{this.props.user.username}</span>
                        <b className={navigationItemsCss.Caret}></b>
                    </Button>
                    <Menu
                        id="menu-appbar"
                        anchorEl={anchorEl}
                    ...
                    >
                        ...
                        <MenuItem onClick={this.handleClose}> Logout <ExitToApp /></MenuItem>
                    </Menu>
                </div>
            </ul>
        )
...
export default connect(mapStateToProps, { ...authActions })(withStyles(styles)(NavigationItems));
